...
<section class="py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div class="glass-card p-5 text-center reveal" style="transition-delay: 0.2s">
                ...
                <p class="text-xs text-gray-400 mt-1">hello@nqtdev.com</p>
            </div>
            <div class="glass-card p-5 text-center reveal" style="transition-delay: 0.25s">
                ...
                <p class="text-xs text-gray-400 mt-1">github.com/nqt</p>
            </div>
            <div class="glass-card p-5 text-center reveal" style="transition-delay: 0.3s">
