...
<body class="min-h-screen flex flex-col">
    {{-- Navigation --}}
    <nav id="main-nav" class="fixed top-0 left-0 right-0 z-50 bg-transparent transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="hidden md:flex items-center gap-1">
                    <a href="{{ route('home') }}" class="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-all {{ request()->routeIs('home') ? 'text-white bg-white/5' : '' }}" id="nav-home">Trang chủ</a>
                    <a href="{{ route('projects.index') }}" class="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-all {{ request()->routeIs('projects.*') ? 'text-white bg-white/5' : '' }}" id="nav-projects">Dự án</a>
                    <a href="{{ route('products.index') }}" class="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-all {{ request()->routeIs('products.*') ? 'text-white bg-white/5' : '' }}" id="nav-shop">Cửa hàng</a>
                    <a href="{{ route('contact.create') }}" class="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-all {{ request()->routeIs('contact.*') ? 'text-white bg-white/5' : '' }}" id="nav-contact">Liên hệ</a>
                </div>

                {{-- Cart + Mobile Toggle --}}
                <div class="flex items-center gap-3">
                    <a href="{{ route('cart.index') }}" class="relative p-2 text-gray-300 hover:text-white transition-colors" id="nav-cart">
            ...
            <div id="mobile-nav-menu" class="hidden md:hidden pb-4">
                <div class="bg-[#0f172a] border border-white/10 shadow-2xl rounded-2xl p-4 space-y-1 relative z-50">
                    ...
                    <a href="{{ route('contact.create') }}" class="block px-4 py-3 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-all">Liên hệ</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:bg-primary/20 hover:text-primary transition-all" aria-label="GitHub">
